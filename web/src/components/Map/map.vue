    ...
    <div id="maps">
        ...
        <div>
            <el-row class="container">
                <el-col :span="18">
                    <div class="mapbox">
                        <baidu-map class="map" center="中国" :map-click="false" v-if="allDevice" :scroll-wheel-zoom="true" @ready="handler" >
                                ...
                                <div v-for="(marker, i) of allDevice" :key="i">
                                    <bm-marker
                                        :icon="{
                                            url:
                                                marker.status == '正常'
                                                    ? require('../../../public/bposition.png')
                                                    : marker.status == '报警'
                                                    ? require('../../../public/rposition.png')
                                                    : require('../../../public/yposition.png'),
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <el-button class="my-2" @click="showDrawer(marker.id)">查看更多</el-button>
                                        </bm-info-window>
                                    </bm-marker>
                                </div>
        ...
        <el-drawer :title="drawerData.device_name" :visible.sync="drawer" direction="rtl" size="35%">
